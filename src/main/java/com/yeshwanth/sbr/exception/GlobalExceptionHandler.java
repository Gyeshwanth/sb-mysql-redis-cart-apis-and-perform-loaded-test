...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CacheUpdateException.class)
    public ResponseEntity<ErrorResponse> handleCacheUpdateException(CacheUpdateException ex) {
        ErrorResponse error = new ErrorResponse(
                HttpStatus.INTERNAL_SERVER_ERROR.value(),
                "Cache update failed: " + ex.getMessage(),
                System.currentTimeMillis()
        );
